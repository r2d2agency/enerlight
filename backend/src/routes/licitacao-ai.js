...
function normalizeParsedEditalData(payload) {
  ...
  return {
    ...data,
    title: (normalizeText(data.title) || '').substring(0, 500),
    edital_number: (normalizeText(data.edital_number) || '').substring(0, 100) || null,
    modality: (normalizeText(data.modality) || '').substring(0, 100) || null,
    ...
    entity_name: (normalizeText(data.entity_name) || '').substring(0, 500) || null,
    entity_cnpj: (normalizeText(data.entity_cnpj) || '').substring(0, 20) || null,
    entity_contact: (normalizeText(data.entity_contact) || '').substring(0, 255) || null,
    entity_phone: (normalizeText(data.entity_phone) || '').substring(0, 50) || null,
    entity_email: (normalizeText(data.entity_email) || '').substring(0, 255) || null,

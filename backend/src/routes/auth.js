...
const SESSION_PERMISSION_PREFIXES = ['can_view_', 'can_edit_', 'can_delete_', 'can_validate_', 'can_manage_', 'can_approve_', 'can_accept_', 'can_refuse_', 'can_create_', 'can_manage_representative_config', 'is_representative'];

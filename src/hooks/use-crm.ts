...
export function useCRMCompaniesPaginated(params: { search?: string; page: number; pageSize: number; cnae_group_id?: string; has_open_deals?: boolean; qualification?: string; group_id?: string; deal_from?: string; deal_to?: string; sort?: string; direction?: 'asc' | 'desc' }) {
  return useQuery({
    queryKey: ["crm-companies-paginated", params.search, params.page, params.pageSize, params.cnae_group_id, params.has_open_deals, params.qualification, params.group_id, params.deal_from, params.deal_to, params.sort, params.direction],
    queryFn: async () => {

...
const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'can_view_supervisor_ia', label: 'Supervisor IA', description: 'Painel de supervisão IA' },
      ...
      { key: 'can_manage_online_quotes', label: 'Gerenciar Orçamentos', description: 'Ver todos os orçamentos, modelos e configurações do módulo' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'can_delete_homologation', label: 'Excluir Homologação', description: 'Permite excluir itens' },
    ],
  },
  {
    title: 'Licitações',
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'can_create_devolucoes', label: 'Abrir RMA (vendedor)', description: 'Permite que o vendedor crie novas solicitações de devolução' },

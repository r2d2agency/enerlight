...
const getNavSections = (hasConnections: boolean): NavSection[] => [
  {
    ...
    items: [
      ...
      { name: "Secretária IA", href: "/secretaria-grupos", icon: Bot, moduleKey: 'group_secretary' as const, permissionKey: 'can_view_ai_secretary' },
      { name: "Agentes IA", href: "/agentes-ia", icon: Sparkles, moduleKey: 'ai_agents' as const, permissionKey: 'can_view_ai_agents' },
      ...(hasConnections ? [{ name: "Chatbots", href: "/chatbots", icon: Bot, moduleKey: 'chatbots' as const, permissionKey: 'can_view_chatbots' }] : []),
      ...(hasConnections ? [{ name: "Fluxos", href: "/fluxos", icon: GitBranch, moduleKey: 'chatbots' as const, permissionKey: 'can_view_flows' }] : []),
      { name: "Departamentos", href: "/departamentos", icon: Building2, permissionKey: 'can_view_departments' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Empresas / Meus Clientes", href: "/crm/empresas", icon: Building2, permissionKey: 'can_view_companies' },
      ...
      { name: "Representantes", href: "/crm/representantes", icon: Handshake, moduleKey: 'representatives', permissionKey: 'can_view_representatives' },
      { name: "Hub de Representantes", href: "/crm/representantes-hub", icon: Users, moduleKey: 'representatives', permissionKey: 'can_view_representatives', adminOnly: true },
      { name: "Painel Representante", href: "/crm/representante-dashboard", icon: LayoutDashboard, permissionKey: 'can_view_representative_dashboard' },
      { name: "Metas", href: "/crm/metas", icon: Target, moduleKey: 'goals', permissionKey: 'can_view_goals' },
      { name: "Comissões da Equipe", href: "/comissoes/equipe", icon: Users, permissionKey: 'can_view_team_commission' },
      { name: "Minha Comissão", href: "/comissoes/minhas", icon: Wallet, permissionKey: 'can_view_crm' },
      ...
      { name: "FollowUp Fábrica", href: "/crm/followup-fabrica", icon: Factory, moduleKey: 'goals', permissionKey: 'can_view_goals' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Gestão de Equipe", href: "/folha-pagamento", icon: Receipt, permissionKey: 'can_view_payroll' },
    ],
  },
  {
    title: "Captador",

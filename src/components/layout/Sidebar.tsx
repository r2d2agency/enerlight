...
const getNavSections = (hasConnections: boolean): NavSection[] => [
  {
    ...
    items: [
      ...
      { name: "Agentes IA", href: "/agentes-ia", icon: Sparkles, moduleKey: 'ai_agents' as const, adminOnly: true, permissionKey: 'can_view_ai_agents' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Orçamentos Online", href: "/crm/orcamentos", icon: FileText, permissionKey: 'can_view_crm' },

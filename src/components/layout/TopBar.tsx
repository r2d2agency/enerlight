...
export function TopBar() {
  ...
  return (
    <div className="hidden lg:flex sticky top-0 right-0 left-0 h-14 items-center justify-between gap-4 px-6 bg-background/80 backdrop-blur-sm border-b border-border/50 z-40 w-full shrink-0">

      ...
      <div className="space-y-8 min-w-0 overflow-hidden">
        ...
        <div className="animate-slide-up">
          ...
          <p className="mt-1 text-muted-foreground">
            Visão geral do seu sistema. Para gerenciar pedidos, vá em CRM {'->'} Negociações. Lá você encontrará as opções de subcategoria e filtros por marca. Agora você também pode mapear manualmente as colunas na importação de tabelas de preço.
          </p>
        </div>

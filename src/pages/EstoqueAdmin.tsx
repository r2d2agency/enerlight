...
export default function EstoqueAdmin() {
  const { produtos, movimentos, alertas, movimento, produto, bom, consumirComposto, produzir, recarregar } = useEstoque();
